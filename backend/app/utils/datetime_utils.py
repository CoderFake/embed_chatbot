...
def now() -> datetime:
    """
    Get current datetime in application timezone (aware, with tzinfo).
    This matches PostgreSQL TIMESTAMP WITH TIME ZONE columns used in models.
    
    Returns:
        Current datetime in system timezone (Asia/Ho_Chi_Minh) with tzinfo
    """
    tz = get_timezone()
